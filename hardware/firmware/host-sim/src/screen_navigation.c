...
static void fill_rect(host_sim_canvas_t *canvas, int x, int y, int w, int h,
                      uint8_t r, uint8_t g, uint8_t b)
{
...
static void center_text(host_sim_canvas_t *canvas, const char *text, int y,
...
static void draw_arrow_straight(host_sim_canvas_t *canvas, int cx, int cy,
                                uint8_t r, uint8_t g, uint8_t b)
{
...
static void draw_arrow_u_turn(host_sim_canvas_t *canvas, int cx, int cy, int dir,
                              uint8_t r, uint8_t g, uint8_t b)
{
...
static void draw_arrow_arrive(host_sim_canvas_t *canvas, int cx, int cy,
                              uint8_t r, uint8_t g, uint8_t b)
{
...
static void draw_arrow_roundabout(host_sim_canvas_t *canvas, int cx, int cy,
                                  uint8_t r, uint8_t g, uint8_t b)
{
...
static void draw_arrow_fork(host_sim_canvas_t *canvas, int cx, int cy, int dir,
                            uint8_t r, uint8_t g, uint8_t b)
{
    /* Main shaft. */
...
static void draw_arrow(host_sim_canvas_t *canvas,
                       host_sim_arrow_shape_t shape,
                       int cx, int cy,
                       uint8_t r, uint8_t g, uint8_t b)
{
    switch (shape) {
...
void host_sim_render_navigation(host_sim_canvas_t    *canvas,
                                ...
                                uint8_t               flags)
{
    ...
    const host_sim_arrow_shape_t shape =
        host_sim_nav_arrow_shape(nav->maneuver);
    draw_arrow(canvas, shape, arrow_cx, arrow_cy, fg_r, fg_g, fg_b);

    /* Distance readout: large, just below the arrow. */
    char dist_buf[16];
    (void)host_sim_nav_format_distance(nav->distance_to_maneuver_m,
    ...
    char eta_buf[40];
    (void)host_sim_nav_format_eta_line(nav->eta_minutes,
                                       nav->remaining_km_x10,
