                                               ...
                                               int cx, int cy, int radius)
{
     ...
     */
    const int32_t relative_x10 = (int32_t)tick_deg_x10 - (int32_t)heading_deg_x10;
    const uint16_t screen_angle_x10 = host_sim_compass_normalize_deg_x10(relative_x10);
    const double theta_rad = ((double)screen_angle_x10 / 10.0) * (M_PI / 180.0);
