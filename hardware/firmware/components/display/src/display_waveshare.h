...
/* ------------------------------------------------------------------ */
/*
 * Verified against Waveshare ESP32-S3-Touch-AMOLED-1.75 ESPHome config
 * and product wiki (April 2026). CO5300 QSPI interface.
 */
#define WS_PIN_CS  12
 ...
 * Matched against official Waveshare ESP-IDF BSP (April 2026):
 * github.com/waveshareteam/ESP32-S3-Touch-AMOLED-1.75
 * components/esp32_s3_touch_amoled_1_75/esp32_s3_touch_amoled_1_75.c
 */
static const ws_init_cmd_t ws_init_cmds[] = {
    /* Vendor command page 0x20. */
    { 0xFE, 1, { 0x20 }, 0 },
    { 0x19, 1, { 0x10 }, 0 },
    { 0x1C, 1, { 0xA0 }, 0 },

    /* Back to standard command page. */
    { 0xFE, 1, { 0x00 }, 0 },
    ...
    /* Write display brightness control. */
    { 0x53, 1, { 0x20 }, 0 },
    ...
    /* Column address: 0x0006 to 0x01D7 (6 to 471). */
    { CMD_COL_ADDR_SET, 4, { 0x00, 0x06, 0x01, 0xD7 }, 0 },

    /* Row address: 0x0000 to 0x01D1 (0 to 465). */
    { CMD_ROW_ADDR_SET, 4, { 0x00, 0x00, 0x01, 0xD1 }, 0 },

    /* Sleep out — panel needs ~600 ms. */
    { CMD_SLEEP_OUT, 0, { 0 }, 600 },
