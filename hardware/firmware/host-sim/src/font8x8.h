...
static const uint8_t *font8x8_glyph(char c)
{
    switch (c) {
    case ' ':
        return FONT8X8_SPACE;
    case ':':
        return FONT8X8_COLON;
    case ',':
        return FONT8X8_COMMA;
    case '.':
        return FONT8X8_PERIOD;
    case '/':
        return FONT8X8_SLASH;
    case '+':
        return FONT8X8_PLUS;
    case '-':
        return FONT8X8_MINUS;
    case '^':
        return FONT8X8_DEGREE; /* caret is our degree proxy */
    case '0':
        return FONT8X8_0;
    case '1':
        return FONT8X8_1;
